...
func NewEmerald(cX int, cY int, scn *Scene) *Emerald {
	...
	em.collisionObject = resolv.NewObject(float64(em.offsetX+em.innerOffsetX), float64(em.offsetY+em.innerOffsetX), float64(em.width), float64(em.height), EMERALD_COLLISION_TAG)
